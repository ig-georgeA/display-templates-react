    ...
    <>
      <div className={classes("row-layout master-view-container")}>
        <IgrGrid data={northwindEmployees} primaryKey="employeeID" allowFiltering={true} filterMode="excelStyleFilter" className={classes("ig-typography ig-scrollbar grid")} key={uuid()}>
          ...
          <IgrColumn field="firstName" dataType="string" header="firstName" sortable={true} bodyTemplate={columnBodyTemplate} selectable={false}></IgrColumn>
          <IgrColumn field="title" dataType="string" header="title" sortable={true} bodyTemplate={columnBodyTemplate1} selectable={false}></IgrColumn>
